...
<section class="createCardSection">
    <div class="createCardContainer">
        ...
        <form class="createCardForm" method="get" action="registrationpage.php">
            ...
            <p class="createCardText">Ability Costs are the costs to use ability's you create on the card, see the explainer at the top!</p>
            ...
            <p class="createCardText">Below are the text areas for adding your card's description (start with the abilitys) and flavour text in the other text area</p>
            <label for="description" id="description">Enter your cards abilitys and description: </label>
            <textarea class="createCardTextarea" rows="6" name="description" placeholder="EG: Many have heard the slither of dragging armor and the soft squelch of its voice. But only its victims ever meet its icy gaze."></textarea>
            <label for="designerFlavourText" id="designerFlavourText">Enter your cards flavour text: </label>
            <textarea class="createCardTextarea" rows="6" name="designerFlavourText" placeholder="EG: Many have heard the slither of dragging armor and the soft squelch of its voice. But only its victims ever meet its icy gaze."></textarea>
            <p class="createCardText">Below are fields for the power and toughness of your card (if you have created a spell please leave these on 0</p>
